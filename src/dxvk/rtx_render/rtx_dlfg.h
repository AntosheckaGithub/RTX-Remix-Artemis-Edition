...
namespace dxvk {
  ...
  public:
    ...
    RTX_OPTION_ENV("rtx.dlfg", bool, enable, false, "RTX_DLFG_ENABLE", "Enables DLSS 3.0 frame generation which generates interpolated frames to increase framerate at the cost of slightly more latency."); // note: always use DxvkDevice::isDLFGEnabled() to check if DLFG is enabled, not this option directly // NV-DXVK: DLFG disabled for stability
